...
<template>
  <div>
    <q-card class="bg-white">
      ...
      <q-card-media>
        <img :src="imgPath">
        <q-card-title slot="overlay">Rebbeca Lin's</q-card-title>
      </q-card-media>
      <q-card-main>
...
.title-icon {
  ...
  margin-left: 30px;
  padding: 3px;
  box-shadow: 0 6px 6px -3px rgba(59, 89, 178, 0.2),
    0 10px 14px 1px rgba(59, 89, 178, 0.14),
    0 4px 18px 3px rgba(59, 89, 178, 0.12);
}
.q-card-primary {
  padding: 10px 5px;
}
